...
CSFDandRPLTWindow = plt.figure(
    1,
    figsize=(3, 8)
)  # this should be called later when we know the aspect ratio, but for now, I have it here
...
# Creates the plotting reference.
CSFD = CSFDandRPLTWindow.add_subplot(
    211,
    sharex=RSFD
